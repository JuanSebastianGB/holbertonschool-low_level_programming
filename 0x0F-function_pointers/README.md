...
Write a program that prints the  [opcodes](https://intranet.hbtn.io/rltoken/QpVps-4Tyq8Cb_69hR0SZQ "opcodes")  of its own main function.
...
Note: if you want to translate your opcodes to assembly instructions, you can use, for instance  [udcli](https://intranet.hbtn.io/rltoken/DSC2K4VYYC7tANplwlPHvw "udcli").
