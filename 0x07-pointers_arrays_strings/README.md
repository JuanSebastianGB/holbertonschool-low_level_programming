...
-   [1](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/1.PNG)  - using ltrace to verify the password
-   [2](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/2.PNG)  - Checking if the password variable is store like global variable
-   [3](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/3.PNG)  - using ldd
-   [4](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/4.PNG)  - using radare2 to figureout what kind of cryp has the file
-   [5](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/5.PNG)  - It's Md file
-   [6](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/6.PNG)  - Getting the password in MD5
-   [7](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/7.PNG)  - Using MD5 reverse Hash
-   [8](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/8.PNG)  - checking again the password variable
-   [9](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/9.PNG)  - Declaring password variable like global
-   [10](https://github.com/JuanSebastianGB/holbertonschool-low_level_programming/blob/main/0x07-pointers_arrays_strings/steps_crack/10.PNG)  - Opening successfuly the file
